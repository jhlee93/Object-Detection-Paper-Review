...
<img src="./image/fig2_YOLO_detection_system.png" width=80%> ***YOLO Detection System***
<br /><br />
...
아래 그림은 YOLO에서 사용한 Darknet Architecture를 보입니다. GoogLeNet을 일부 변형한 구조로 총 24개의 Convolutional layer와 2개의 Fully connected layer로 구성되어있습니다. feature space를 줄이기 위해 중간중간 1 x 1 Conv layer를 번갈아가며 사용한 것도 확인할 수 있습니다.<br />
<img src="./image/fig3_Darknet-19_architecture.png" width="80%"> ***YOLO Architecture***
<br /><br />
...
YOLO에서 사용한 Loss Function은 아래와 같으며, **Classification Loss, Localization Loss, Confidence Loss** 로 구성되어있습니다. Loss Function에 대한 설명은 [Ref](https://medium.com/@jonathan_hui/real-time-object-detection-with-yolo-yolov2-28b1b93e2088) 설명을 참고하였습니다.<br />

<img src="./image/YOLO_Loss_fucntion.png"> ***Loss Function***
<br /><br />
...
<img src="./image/Classification_Loss.png" width=300> ***Classification Loss***
<br /><br />
...
<img src="./image/Localization_Loss.png" width=500> ***Localization Loss***
<br /><br />
...
<img src="./image/Confidence_Loss.png" width=250> ***Confidence Loss***
<br /><br />
...
<img src="./image/Confidence_Loss_Nondetect.png" width=250> ***Confidence Loss***
<br /><br />
...
<img src="./image/Exper_comparison.png" width=500> ***Real-Time Systems on PASCAL VOC 2007***
<br /><br />
...
<img src="./image/Exper_FasterR-CNN_vs_YOLO.png" width=500> ***Error Analysis: Fast R-CNN vs. YOLO***
<br /><br />

각각의 단점을 보완하기 위해 Faster R-CNN, YOLO를 함께 사용한 결과 아래와 같이 3.2mAP의 정확도를 향상시킬 수 있었습니다.<br />
<img src="./image/Exper_Combining.png" width=500> ***Model combination experiments on VOC 2007***
<br /><br />

Faster R-CNN과 YOLO의 조합은 PASCAL VOC 2012 에서도 다른 검출기들고 비교하여 높은 정확도를 보이고 있습니다.<br />
<img src="./image/Exper_Pascal_VOC2012.png"> ***PASCAL VOC 2012 Leaderboard***
<br /><br />
...
<img src="./image/Exper_generalization.png"> ***Generalization results on Picasso and People-Art datasets***

---

## Reference
- [Paper](https://arxiv.org/abs/1506.02640)
- [YouTube, Deep Sysmtems](https://www.youtube.com/watch?v=L0tzmv--CGY&t=16s)